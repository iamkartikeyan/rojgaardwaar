...
window.ROJGAAR_DATA = (function() {
  ...
  const STATES = [
    { id: "all-india", name: "All India / Central", code: "AI", icon: "🏛️", totalActive: 142 },
    { id: "andhra-pradesh", name: "Andhra Pradesh", code: "AP", icon: "🏢", totalActive: 18 },
    { id: "arunachal-pradesh", name: "Arunachal Pradesh", code: "AR", icon: "🏔️", totalActive: 8 },
    { id: "assam", name: "Assam", code: "AS", icon: "🦏", totalActive: 22 },
    { id: "bihar", name: "Bihar", code: "BR", icon: "🏛️", totalActive: 38 },
    { id: "chandigarh", name: "Chandigarh", code: "CH", icon: "🏙️", totalActive: 6 },
    { id: "chhattisgarh", name: "Chhattisgarh", code: "CG", icon: "🌳", totalActive: 16 },
    { id: "delhi", name: "Delhi NCR", code: "DL", icon: "🏛️", totalActive: 45 },
    { id: "goa", name: "Goa", code: "GA", icon: "🏖️", totalActive: 9 },
    { id: "gujarat", name: "Gujarat", code: "GJ", icon: "🏭", totalActive: 26 },
    { id: "haryana", name: "Haryana", code: "HR", icon: "🌾", totalActive: 24 },
    { id: "himachal-pradesh", name: "Himachal Pradesh", code: "HP", icon: "🏔️", totalActive: 14 },
    { id: "jammu-kashmir", name: "Jammu & Kashmir", code: "JK", icon: "❄️", totalActive: 19 },
    { id: "jharkhand", name: "Jharkhand", code: "JH", icon: "⛏️", totalActive: 17 },
    { id: "karnataka", name: "Karnataka", code: "KA", icon: "💻", totalActive: 29 },
    { id: "kerala", name: "Kerala", code: "KL", icon: "🌴", totalActive: 23 },
    { id: "ladakh", name: "Ladakh", code: "LA", icon: "🏔️", totalActive: 5 },
    { id: "madhya-pradesh", name: "Madhya Pradesh", code: "MP", icon: "🐅", totalActive: 31 },
    { id: "maharashtra", name: "Maharashtra", code: "MH", icon: "🏙️", totalActive: 39 },
    { id: "manipur", name: "Manipur", code: "MN", icon: "🌿", totalActive: 7 },
    { id: "meghalaya", name: "Meghalaya", code: "ML", icon: "☁️", totalActive: 6 },
    { id: "mizoram", name: "Mizoram", code: "MZ", icon: "🎋", totalActive: 5 },
    { id: "nagaland", name: "Nagaland", code: "NL", icon: "🦅", totalActive: 6 },
    { id: "odisha", name: "Odisha", code: "OD", icon: "🛕", totalActive: 25 },
    { id: "puducherry", name: "Puducherry", code: "PY", icon: "🏖️", totalActive: 7 },
    { id: "punjab", name: "Punjab", code: "PB", icon: "🌾", totalActive: 21 },
    { id: "rajasthan", name: "Rajasthan", code: "RJ", icon: "🏰", totalActive: 34 },
    { id: "sikkim", name: "Sikkim", code: "SK", icon: "🏔️", totalActive: 6 },
    { id: "tamil-nadu", name: "Tamil Nadu", code: "TN", icon: "🛕", totalActive: 28 },
    { id: "telangana", name: "Telangana", code: "TS", icon: "🏢", totalActive: 24 },
    { id: "tripura", name: "Tripura", code: "TR", icon: "🌄", totalActive: 7 },
    { id: "uttar-pradesh", name: "Uttar Pradesh", code: "UP", icon: "🕌", totalActive: 52 },
    { id: "uttarakhand", name: "Uttarakhand", code: "UK", icon: "⛰️", totalActive: 19 },
    { id: "west-bengal", name: "West Bengal", code: "WB", icon: "🌉", totalActive: 33 }
  ];

  // Primary Qualifications
  const QUALIFICATIONS = [
    { id: "10th-pass", name: "10th Pass / Matriculation", shortName: "10th Pass", icon: "🎒", desc: "Matriculation jobs in Indian Army, Post Office, MTS, Group D, Police & Railways" },
    { id: "12th-pass", name: "12th Pass / Intermediate / 10+2", shortName: "12th Pass", icon: "📖", desc: "Clerk, CHSL, Constable, NDA, Airmen, Stenographer, Assistant & Technical Posts" },
    { id: "graduate", name: "Graduate (BA, BSc, BCom, Any Degree)", shortName: "Graduate", icon: "🎓", desc: "UPSC Civil Services, SSC CGL, IBPS PO, State PSC, Bank Clerk, Assistant Officers" },
    { id: "diploma", name: "Polytechnic / Engineering Diploma", shortName: "Diploma", icon: "📐", desc: "Junior Engineer (JE), Technical Assistant, Sub-Overseer, PSU Diploma Trainee" },
    { id: "iti", name: "ITI (NCVT / SCVT All Trades)", shortName: "ITI Pass", icon: "🔧", desc: "Railway ALP, Technician, Ordnance Factory, DRDO CEPTAM, ISRO, PSU Trade Apprentices" },
    { id: "btech-engineering", name: "B.Tech / B.E. / Engineering", shortName: "B.Tech / B.E.", icon: "⚙️", desc: "GATE PSU Recruitment, UPSC ESE, Assistant Engineer, ISRO Scientist, DRDO Scientist" },
    { id: "post-graduate", name: "Post Graduate (MA, MSc, MCom)", shortName: "Post Graduate", icon: "📚", desc: "UGC NET, Lecturer, Research Assistant, Statistical Officer, Specialist Positions" },
    { id: "mba-pgdm", name: "MBA / PGDM / Management", shortName: "MBA", icon: "💼", desc: "Management Trainee, HR Officer, Marketing Manager, Bank Specialist Officer (SO)" },
    { id: "mca-bca-it", name: "MCA / BCA / B.Sc (IT / CS)", shortName: "MCA / BCA / IT", icon: "💻", desc: "Programmer, IT Officer, Cyber Security Analyst, NIC Scientist, System Admin" },
    { id: "law-llb", name: "Law / LLB / LLM", shortName: "Law / LLB", icon: "⚖️", desc: "Judicial Service Civil Judge, Legal Advisor, Law Officer, Public Prosecutor, High Court" },
    { id: "medical-nursing", name: "Medical / MBBS / Nursing / BDS / B.Pharm", shortName: "Medical & Nursing", icon: "🩺", desc: "Staff Nurse, Medical Officer, Pharmacist, Lab Technician, AIIMS, ESIC, Railway Hospital" },
    { id: "bed-teaching", name: "B.Ed / D.El.Ed / CTET / TET", shortName: "Teaching / B.Ed", icon: "🧑‍🏫", desc: "PRT, TGT, PGT, KVS, NVS, DSSSB, State Teacher Recruitment, Professor" }
  ];

  // Primary Sectors / Categories
  const CATEGORIES = [
    { id: "central-govt", name: "Central Government Jobs", icon: "🏛️", count: 85 },
    { id: "state-govt", name: "State Government Jobs", icon: "🏢", count: 96 },
    { id: "railway", name: "Railway Jobs (RRB & RRC)", icon: "🚆", count: 32 },
    { id: "banking", name: "Bank & Financial Sector Jobs", icon: "🏦", count: 28 },
    { id: "psu", name: "PSU / Public Sector Undertakings", icon: "🏭", count: 42 },
    { id: "ssc", name: "SSC Jobs (Staff Selection Commission)", icon: "📋", count: 18 },
    { id: "upsc", name: "UPSC Jobs (Civil & Engineering Services)", icon: "🇮🇳", count: 14 },
    { id: "defence", name: "Defence Jobs (Army, Navy, Air Force, Coast Guard)", icon: "🎖️", count: 26 },
    { id: "police", name: "Police & Paramilitary (CAPF, State Police, SI)", icon: "👮", count: 30 },
    { id: "teaching", name: "Teaching & School Faculty", icon: "🧑‍🏫", count: 22 },
    { id: "university", name: "University & College Faculty", icon: "🏛️", count: 15 },
    { id: "courts", name: "Courts & Judicial Services", icon: "⚖️", count: 12 },
    { id: "engineering", name: "Engineering & Technical Jobs", icon: "⚙️", count: 45 },
    { id: "no-exam", name: "No Written Exam / Merit & Interview Jobs", icon: "✨", count: 35 },
    { id: "fresher", name: "Fresher Eligible Government Jobs", icon: "🌱", count: 110 },
    { id: "apprenticeship", name: "Apprenticeship Openings", icon: "📜", count: 24 },
    { id: "admit-card", name: "Admit Cards & Hall Tickets", icon: "🎫", count: 48 },
    { id: "results", name: "Govt Exam Results & Cutoffs", icon: "📊", count: 42 }
  ];
