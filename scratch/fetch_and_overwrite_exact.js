...
async function run() {
  console.log('Fetching top 70 exact articles from indgovtjobs.in feed...');
  const json = await fetchJson('https://www.indgovtjobs.in/feeds/posts/default?alt=json&max-results=70');
