...
const COMMON_HEADER = (activeNav = 'HOME') => `
  <!-- Top Announcement & Utility Bar (Desktop Only) -->
  <div class="site-top-strip">
    <div class="container">
      <div class="top-strip-inner">
        <div class="top-live-tag">
          <span class="live-pulse-dot"></span> LIVE RECRUITMENT UPDATES 2026-27 (1,50,000+ VACANCIES)
        </div>
        <div class="top-strip-links">
          <a href="/admit-cards.html">🎟️ Admit Cards</a>
          <a href="/exam-results.html">📊 Results</a>
          <a href="/central-govt-jobs.html">🏛️ Central Govt</a>
    ...
    <div class="container">
      <div class="brand-header-flex">
        ...
        <div class="header-trust-badges">
          ...
          <a href="https://whatsapp.com/channel/ROZGARDWAAR" target="_blank" rel="noopener noreferrer" class="trust-badge-pill whatsapp">💬 Join WhatsApp</a>
        </div>
  ...
  <nav class="site-primary-navbar">
    <div class="container">
      <ul class="nav-menu-list">
        ...
        <li><a href="/central-govt-jobs.html" class="nav-menu-link ${activeNav === 'GOVT JOBS' ? 'active' : ''}">🏛️ CENTRAL JOBS</a></li>
        ...
        <li><a href="/state-govt-jobs.html" class="nav-menu-link ${activeNav === 'STATE GOVT JOBS' ? 'active' : ''}">🗺️ STATE GOVT</a></li>
      </ul>
    </div>
  </nav>
  ...
  <div id="mobile-nav-drawer" class="mobile-nav-drawer">
    <div class="mobile-drawer-header">
      <div class="mobile-drawer-title">🏛️ RozgarDwaar Menu</div>
    ...
    <div class="mobile-drawer-body">
      ...
      <ul class="mobile-drawer-links">
        ...
        <li><a href="/central-govt-jobs.html" onclick="toggleMobileNav()">🏛️ Central Govt Jobs</a></li>
        ...
        <li><a href="/state-govt-jobs.html" onclick="toggleMobileNav()">🗺️ State Govt Jobs (All States)</a></li>
      </ul>
      ...
      <ul class="mobile-drawer-links">
        ...
        <li><a href="/engineering-jobs.html" onclick="toggleMobileNav()">⚙️ Engineering / B.Tech Jobs</a></li>
      </ul>

      <div class="mobile-drawer-section-title">Quick Tools &amp; Alerts</div>
      <ul class="mobile-drawer-links">
        <li><a href="/admit-cards.html" onclick="toggleMobileNav()">🎟️ Admit Cards &amp; Hall Tickets</a></li>
    ...
    <div class="sidebar-box">
      ...
      <div class="sidebar-box-body">
        <ul class="sidebar-links-list qual-color-list">
          <li class="sidebar-list-item qual-10th-12th"><a href="/10th-12th-pass-jobs.html">✔ 10th 12th Pass Government Jobs</a></li>
          <li class="sidebar-list-item qual-graduate"><a href="/graduate-jobs.html">✔ Graduate Government Jobs</a></li>
          <li class="sidebar-list-item qual-diploma"><a href="/diploma-jobs.html">✔ Diploma Government Jobs</a></li>
          <li class="sidebar-list-item qual-iti"><a href="/iti-jobs.html">✔ ITI Government Jobs</a></li>
          <li class="sidebar-list-item qual-engg"><a href="/engineering-jobs.html">✔ Engineering Government Jobs</a></li>
          <li class="sidebar-list-item qual-mba"><a href="/graduate-jobs.html">✔ MBA Government Jobs</a></li>
          <li class="sidebar-list-item qual-mca"><a href="/engineering-jobs.html">✔ MCA Government Jobs</a></li>
          <li class="sidebar-list-item qual-law"><a href="/graduate-jobs.html">✔ Law Government Jobs</a></li>
          <li class="sidebar-list-item qual-pg"><a href="/graduate-jobs.html">✔ Post Graduate Government Jobs</a></li>
        </ul>
      </div>
    </div>
  ...
  <section class="site-bottom-directory">
    <div class="container">
      <div class="bottom-directory-grid">
        ...
        <div class="bottom-dir-box">
          <div class="bottom-dir-header">Our Job Alert Channels</div>
          <div class="bottom-dir-body">
            <ul class="sidebar-links-list">
